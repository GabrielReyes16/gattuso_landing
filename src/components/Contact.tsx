...
import { businessHours, deliveryZones, businessInfo } from '@/lib/mock-data';
        ...
        <section id="ubicanos" className="py-20 md:py-28 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    >
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1500!2d-77.01356181320072!3d-12.078897101101058!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105c9e8a0190c2d%3A0x2f9450aa846448ac!2sGattuso%20chicken%202!5e0!3m2!1ses!2spe!4v1769230855468!5m2!1ses!2spe"
                            width="100%"
                            height="100%"
                            style={{ border: 0 }}
                            allowFullScreen
                        ...
                        <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[var(--gray-600)]">{businessInfo.address}</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="bg-gradient-to-r from-[var(--brasa-red)] to-[var(--warm-orange)] rounded-3xl p-6 text-white">
                            ...
                            <a
                                ...
                                className="flex items-center justify-center gap-2 bg-white text-[var(--brasa-red)] font-bold py-3 px-6 rounded-full hover:bg-[var(--cream)] transition-colors w-full"
                            >
