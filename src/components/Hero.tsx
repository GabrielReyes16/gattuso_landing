                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            ...
                            <motion.a
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-full text-lg font-bold transition-all shadow-xl shadow-green-500/30"
                            >
                        ...
                        <div className="relative animate-float">
                            <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[450px] lg:h-[450px] mx-auto">
                                ...
                                <div className="absolute inset-4 rounded-full bg-gradient-to-br from-[var(--cream)] to-[var(--golden-yellow-light)] flex items-center justify-center overflow-hidden shadow-2xl">
                                    <span className="text-[120px] sm:text-[150px] md:text-[180px]">🍗</span>
                                </div>
                                ...
                                <motion.div
                                    ...
                                    className="absolute top-1/4 -left-6 bg-[var(--brasa-red)] text-white rounded-full px-3 py-1 text-sm font-bold shadow-lg"
                                >
                                    ¡Nuevo!
                                </motion.div>
                            </div>
