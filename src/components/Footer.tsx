                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    >
                        ...
                        <div className="flex gap-3">
                            <a
                                ...
                                className="bg-white/10 hover:bg-[var(--brasa-red)] p-3 rounded-xl transition-colors"
                                aria-label="Facebook"
                            >
                    ...
                    >
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <a
                                    href="mailto:info@labraseria.pe"
                                    className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors"
                                >
                                    <Mail className="w-5 h-5 text-[var(--brasa-red)]" />
                                    <span className="text-sm">info@labraseria.pe</span>
                                </a>
                            </li>
                        </ul>
                    </motion.div>
