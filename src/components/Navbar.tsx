...
export default function Navbar() {
    ...
    const handlePedirClick = () => {
        setIsOpen(false);
        openSelector(businessInfo.whatsappMessage);
    };
                    ...
                    <div className="flex items-center justify-between h-20 md:h-24">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <button
                                ...
                                className="bg-[var(--brasa-red)] hover:bg-[var(--brasa-red-dark)] text-white px-5 py-2.5 rounded-full font-semibold transition-all hover:scale-105 shadow-lg shadow-[var(--brasa-red)]/30 cursor-pointer"
                            >
                                Pedir Ahora
                            </button>
                        </div>
                        ...
                        >
                            <div className="px-4 py-4 space-y-3">
                                ...
                                <button
                                    ...
                                    className="block w-full text-center bg-[var(--brasa-red)] hover:bg-[var(--brasa-red-dark)] text-white py-3 rounded-full font-semibold transition-all cursor-pointer"
                                >
                                    🍗 Pedir Ahora
                                </button>
                            </div>
