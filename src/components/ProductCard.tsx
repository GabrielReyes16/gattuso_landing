            ...
            >
                ...
                <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <motion.button
                            onClick={() => openSelector(whatsappMessage)}
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="flex items-center gap-1.5 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full text-sm font-semibold transition-colors cursor-pointer"
                        >
